LANGS = {
    "en": {
        ...
        "stats_users": "Users",
        "broadcast_prompt": "Send the message you want to broadcast to all registered groups. It will be prepared once and sent through the stored bots.",
        ...
        "loop_enter_message": "Send the message, photo, GIF, voice note, sticker, or other media to broadcast. It will be prepared once and sent through the stored bots.",
    ...
    "he": {
        ...
        "loop_enter_interval": "כמה שניות להמתין בין האצוות?",
        "loop_enter_message": "שלחו את ההודעה, התמונה, ה-GIF, ההודעה הקולית, הסטיקר או כל מדיה אחרת לשידור.",
        "loop_started": "שידור בלולאה התחיל.",
