LANGS = {
    "en": {
        ...
        "send_message": "📝 Send any message you want to broadcast.\n\nSupported: text, photos, videos, GIFs, documents, stickers, voice, audio, polls, location, contact, venue, dice, and more.",
        ...
        "stats_users": "Users",
        "broadcast_prompt": "Send the message you want to copy to all registered groups. The engine will copy it directly for best speed.",
        "broadcast_done": "✅ Broadcast finished.\nSent: {sent}\nFailed: {failed}",
        "broadcast_started": "🚀 Broadcast started.\nUse /stopbroadcast to stop it.",
        "broadcast_stop_requested": "⏸️ Stop requested. The current batch will stop shortly.",
    ...
    "he": {
        ...
        "send_message": "📝 שלח כל הודעה שתרצה לשדר.\n\nנתמך: טקסט, תמונות, סרטונים, GIF, מסמכים, סטיקרים, קול, אודיו, סקרים, מיקום, איש קשר, מקום, קוביה ועוד.",
        ...
        "stats_users": "משתמשים",
        "broadcast_prompt": "שלחו את ההודעה שתרצו להעתיק לכל הקבוצות הרשומות. הבוט יעתיק אותה ישירות כדי להיות מהיר יותר.",
        "broadcast_done": "✅ השידור הסתיים.\nנשלח: {sent}\nנכשל: {failed}",
        "broadcast_started": "🚀 השידור התחיל.\nאפשר לעצור אותו עם /stopbroadcast.",
        "broadcast_stop_requested": "⏸️ בקשת עצירה התקבלה. האצווה הנוכחית תיעצר בקרוב.",
        "broadcast_stopped": "🛑 השידור נעצר.",
    ...
    "sr": {
        ...
        "send_message": "📝 Pošaljite poruku koju želite da objavite.\n\nPodržano: tekst, fotografije, video, GIF, dokumenti, stikeri, glas, audio, ankete, lokacija, kontakt, mesto, kocka i još mnogo toga.",
        ...
        "broadcast_prompt": "Pošaljite poruku koju želite da kopirate u sve registrovane grupe. Engine će je kopirati direktno radi veće brzine.",
        "broadcast_done": "✅ Objavljivanje završeno.\nPoslato: {sent}\nNeuspešno: {failed}",
        "broadcast_started": "🚀 Objavljivanje je počelo.\nZa zaustavljanje koristite /stopbroadcast.",
        "broadcast_stop_requested": "⏸️ Zahtev za zaustavljanje je primljen. Trenutna serija će uskoro stati.",
        "broadcast_stopped": "🛑 Objavljivanje je zaustavljeno.",
